...
C:<br/>
├── @arction/lcjs@5.2.1<br/>
├── @eslint/js@9.39.3<br/>
├── @tailwindcss/postcss@4.2.1<br/>
├── @tanstack/react-query@5.90.21<br/>
├── @tanstack/react-table@8.21.3<br/>
├── @tanstack/react-virtual@3.13.20<br/>
├── @types/node@24.10.13<br/>
├── @types/react-dom@19.2.3<br/>
├── @types/react@19.2.14<br/>
├── @vitejs/plugin-react@5.1.4<br/>
├── ag-grid-community@35.1.0<br/>
├── ag-grid-react@35.1.0<br/>
├── autoprefixer@10.4.24<br/>
├── axios@1.13.5<br/>
├── chart.js@4.5.1<br/>
├── eslint-plugin-react-hooks@7.0.1<br/>
├── eslint-plugin-react-refresh@0.4.26<br/>
├── eslint@9.39.3<br/>
├── globals@16.5.0<br/>
├── lucide-react@0.575.0<br/>
├── postcss@8.5.6<br/>
├── react-chartjs-2@5.3.1<br/>
├── react-dom@19.2.4<br/>
├── react-router-dom@7.13.1<br/>
├── react@19.2.4<br/>
├── recharts@3.7.0<br/>
├── tailwindcss@4.2.1<br/>
├── typescript-eslint@8.56.1<br/>
├── typescript@5.9.3<br/>
├── vite@7.3.1<br/>
└── zustand@5.0.11<br/>
## React Compiler
